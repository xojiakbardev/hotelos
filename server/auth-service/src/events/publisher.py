...
Wraps Redis Pub/Sub with the canonical HotelOS envelope. Used so other
services can keep a local projection of staff (esp. technicians) without
ever calling auth-service over HTTP.
"""
...
logger = logging.getLogger("auth-service.publisher")
